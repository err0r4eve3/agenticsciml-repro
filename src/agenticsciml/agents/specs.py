...
AGENT_SPECS: dict[str, AgentSpec] = {
    ...
    "proposer": AgentSpec(
        ...
        visible_context=("parent analysis", "one KB entry", "local related reports", "optional operator assignment"),
    ...
    "result_analyst": AgentSpec(
        ...
        visible_context=("eval.json", "train.log", "prediction-only observation manifest", "prediction overview plot"),
        tools=("llm", "filesystem write"),
        budget={"calls": 1},
        artifacts=("analysis.md", "solution_observations.json", "prediction_overview.svg"),

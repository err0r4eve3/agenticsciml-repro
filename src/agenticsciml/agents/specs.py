...
AGENT_SPECS: dict[str, AgentSpec] = {
    ...
    "engineer": AgentSpec(
        ...
        output_schema=("mutation_summary", "expected_effect", "risks", "parent_digest", "files_changed"),
        visible_context=("problem bundle", "parent code", "parent analysis", "proposal", "evaluation contract"),
        tools=("llm", "filesystem write"),
        budget={"calls": 1},

...
BENCHMARKS: dict[str, BenchmarkSpec] = {
    ...
    "function_approx_faithful_small": BenchmarkSpec(
        name="function_approx_faithful_small",
        path=EXAMPLES_DIR / "function_approx_faithful_small",
        paper_section="S1.1",
        paper_task_name="Discontinuous function fitting",
        family="function approximation",
        metric="validation_mse",
        description="Faithful-small piecewise function approximation with 200 training points and 500 validation points.",
    ...
    "burgers_pinn_faithful_small": BenchmarkSpec(
        name="burgers_pinn_faithful_small",
        path=EXAMPLES_DIR / "burgers_pinn_faithful_small",
        paper_section="S1.3",
        paper_task_name="Burgers PINN",
        family="PINN",
        metric="burgers_pinn_composite",
        description="Faithful-small time-dependent Burgers task with IC/BC anchors and collocation coordinates.",
        fidelity_level="faithful-small",
        expected_runtime_s=45,
        requires_torch=True,
        requires_gpu=False,
    ...
    "antiderivative_operator_faithful_small": BenchmarkSpec(
        name="antiderivative_operator_faithful_small",
        path=EXAMPLES_DIR / "antiderivative_operator_faithful_small",
        paper_section="S1.4",
        paper_task_name="Antiderivative operator learning",
        family="operator learning",
        metric="relative_l2",
        description="Faithful-small neural-operator task mapping 100-point functions to antiderivatives.",
        fidelity_level="faithful-small",
        expected_runtime_s=45,
        requires_torch=True,
        requires_gpu=False,
    ...
    "reaction_diffusion_operator_faithful_small": BenchmarkSpec(
        name="reaction_diffusion_operator_faithful_small",
        path=EXAMPLES_DIR / "reaction_diffusion_operator_faithful_small",
        paper_section="S1.5",
        paper_task_name="Reaction-diffusion multiple-input operator learning",
        family="operator learning",
        metric="relative_l2",
        description="Faithful-small multiple-input operator mapping diffusion/source/initial fields to a spatiotemporal response.",
        fidelity_level="faithful-small",
        expected_runtime_s=45,
        requires_torch=True,
        requires_gpu=False,

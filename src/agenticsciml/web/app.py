...
CURATED_PAPER_PROBLEM_CASES: tuple[dict[str, object], ...] = (
    {
        ...
        "title_zh": "AgenticSciML: 面向科学机器学习涌现发现的协作式多智能体系统",
        "authors": ["Qile Jiang", "George Em Karniadakis"],
        "submitted": "2025-11-10",
        "published": "2026-04-30",
        "url": "https://www.nature.com/articles/s44387-026-00102-5",
        "summary": "Coordinates specialized agents for proposal, critique, retrieval, engineering, evaluation, and evolutionary refinement in SciML.",
        "summary_zh": "把 proposer、critic、retriever、engineer、evaluator 等角色放进可审计的演化循环，用于探索 SciML 建模策略。",
        "real_problem": "Automate expert-heavy SciML model design without upgrading unverified agent outputs into scientific claims.",
        "real_problem_zh": "减少 SciML 架构、损失函数和训练策略设计对人工专家反复试错的依赖，同时避免把未验证的 agent 输出误当科学结论。",
        "project_hooks": ["project:agenticsciml", "workflow:claim_gate", "workflow:problem_intake"],
        "tags": ["paper", "agenticsciml", "multi-agent", "sciml"],
        "tags_zh": ["论文", "多智能体", "科学机器学习", "证据边界"],
    },
    {
        "id": "paper:deepseek_chatgpt_claude_sciml",
        "title": "DeepSeek vs. ChatGPT vs. Claude: A Comparative Study for Scientific Computing and Scientific Machine Learning Tasks",
        "title_zh": "DeepSeek、ChatGPT 与 Claude 在科学计算和科学机器学习任务上的比较研究",
        "authors": ["Qile Jiang", "Zhiwei Gao", "George Em Karniadakis"],
        "submitted": "2025-02-25",
        "url": "https://arxiv.org/abs/2502.17764",
        "summary": "Compares LLM behavior on scientific computing and SciML tasks, supporting explicit model routing and audit boundaries.",
        "summary_zh": "比较不同 LLM 在科学计算与 SciML 任务中的表现，提示项目需要显式记录模型路由、预算和失败边界。",
        "real_problem": "Choose and audit LLMs for scientific code, math reasoning, and SciML planning under budget and reliability limits.",
        "real_problem_zh": "在预算、延迟和可靠性限制下选择并审计适合科学代码、数学推理和 SciML 规划的 LLM。",
        "project_hooks": ["workflow:trace_summary_quality_gate", "workflow:problem_intake"],
        "tags": ["paper", "llm-evaluation", "scientific-computing", "model-routing"],
        "tags_zh": ["论文", "模型评测", "科学计算", "路由审计"],
    },
    {
        ...
        "title_zh": "通过 PINN 求解器无关训练实现跨钝体形状泛化的湍流闭合",
        ...
        "summary_zh": "用 PINN 训练 RANS 闭合可减少求解器内循环标定，适合推动求解器无关的闭合模型审计。",
        "real_problem": "Learn turbulence closures that generalize across bluff-body wakes and remain stable when frozen into a CFD solver.",
        "real_problem_zh": "学习能跨钝体尾流泛化、并在冻结后接入 CFD 求解器仍保持稳定的湍流闭合。",
    ...
    },
    {
        ...
        "title_zh": "面向大规模 Newton 求解器的谱安全神经算子热启动",
        ...
        "summary_zh": "低预测误差仍可能不满足 Newton 收敛盆或 Jacobian 谱安全，因此算子模型需要稳定性诊断。",
        "real_problem": "Use neural operators as warm starts for million-DOF nonlinear PDE solves without breaking Krylov/Newton assumptions.",
        "real_problem_zh": "把神经算子作为百万自由度非线性 PDE 的热启动，同时不破坏 Krylov/Newton 求解的谱条件。",
        "project_hooks": ["workflow:trace_summary_quality_gate", "algorithm:deeponet_operator"],
        "tags": ["paper", "neural-operator", "stability", "newton"],
        "tags_zh": ["论文", "神经算子", "稳定性", "Newton求解"],
    },
    {
        ...
        "title_zh": "PDE 约束反问题中的伴随方法与物理信息神经网络比较",
        ...
        "summary_zh": "未知量表示方式常决定伴随法或 PINN 哪个更适合本地反问题策略。",
        "real_problem": "Recover unknown PDE parameters or sources while separating optimization failure from model-form mismatch.",
        "real_problem_zh": "恢复未知 PDE 参数或源项，并区分优化失败与模型形式不匹配。",
        "project_hooks": ["workflow:problem_intake", "algorithm:pinn_residual_minimizer"],
        "tags": ["paper", "inverse-problem", "pinn", "adjoint"],
        "tags_zh": ["论文", "反问题", "PINN", "伴随法"],
    },
    {
        "id": "paper:agents_last_exam",
        "title": "Agents' Last Exam",
        "title_zh": "Agents' Last Exam：长周期真实任务智能体评测",
        ...
        "summary_zh": "长周期智能体评测强调可验证结果、可复查轨迹和失败默认关闭的动作边界。",
        "real_problem": "Evaluate agents on economically valuable long-horizon work where outcomes are externally verifiable.",
        "real_problem_zh": "评测智能体能否完成有经济价值、长周期、且结果可外部验证的现实工作。",
        "project_hooks": ["workflow:claim_gate", "workflow:trace_summary_quality_gate"],
        "tags": ["paper", "agent-benchmark", "evaluation"],
        "tags_zh": ["论文", "智能体评测", "长周期任务"],
    },
    {
        "id": "paper:spectral_audit_in_context_operator_networks",
        "title": "Spectral Audit of In-Context Operator Networks",
        "title_zh": "上下文算子网络的谱审计",
        ...
        "summary_zh": "单看预测误差可能掩盖错误的局部切算子动力学，算子学习需要谱响应和敏感性审计。",
        "real_problem": "Detect operator models that predict outputs well but learn unstable sensitivities or wrong frequency response.",
        "real_problem_zh": "发现那些输出预测看似准确、但敏感性或频率响应错误的算子模型。",
    ...
    {
        "id": "paper:pinns_forward_inverse_pdes",
        "title": "Physics Informed Deep Learning (Part I): Data-driven Solutions of Nonlinear Partial Differential Equations",
        "title_zh": "物理信息深度学习（一）：非线性偏微分方程的数据驱动求解",
        "authors": ["Maziar Raissi", "Paris Perdikaris", "George Em Karniadakis"],
        "submitted": "2017-11-28",
        "url": "https://arxiv.org/abs/1711.10561",
        "summary": "PINNs encode PDE laws into neural training objectives for forward and inverse nonlinear PDE tasks.",
        "summary_zh": "PINN 把 PDE 物理律写入神经网络训练目标，用于非线性 PDE 的正问题和反问题。",
        "real_problem": "Solve or identify nonlinear PDE systems from sparse observations while respecting known physics.",
        "real_problem_zh": "在稀疏观测下求解或辨识非线性 PDE 系统，并显式遵守已知物理约束。",
        "project_hooks": ["algorithm:pinn_residual_minimizer", "benchmark:burgers_pinn_faithful_small"],
        "tags": ["paper", "pinn", "pde", "inverse-problem"],
        "tags_zh": ["论文", "PINN", "偏微分方程", "反问题"],
    },
    {
        "id": "paper:deeponet_nonlinear_operators",
        ...
        "title_zh": "DeepONet：基于算子通用逼近定理学习非线性算子以识别微分方程",
        "authors": ["Lu Lu", "Pengzhan Jin", "George Em Karniadakis"],
        "submitted": "2019-10-08",
        "url": "https://arxiv.org/abs/1910.03193",
        "summary": "DeepONet learns mappings between functions with branch/trunk networks, motivating operator-learning benchmark prompts.",
        "summary_zh": "DeepONet 通过 branch/trunk 网络学习函数到函数的映射，是算子学习 benchmark 和提示词的重要基础。",
        "real_problem": "Learn reusable solution operators for families of differential equations instead of solving one instance at a time.",
        "real_problem_zh": "学习可复用的微分方程族解算子，而不是每个参数实例重新求解一次。",
        "project_hooks": ["algorithm:deeponet_operator", "benchmark:antiderivative_operator_faithful_small"],
        "tags": ["paper", "deeponet", "operator-learning"],
        "tags_zh": ["论文", "DeepONet", "算子学习"],
    },
    {
        "id": "paper:fourier_neural_operator_parametric_pdes",
        "title": "Fourier Neural Operator for Parametric Partial Differential Equations",
        "title_zh": "面向参数化偏微分方程的 Fourier Neural Operator",
        ...
        "summary": "FNO parameterizes operator kernels in Fourier space for fast surrogate solving across parametric PDE families.",
        "summary_zh": "FNO 在 Fourier 空间参数化算子核，用于参数化 PDE 族的快速代理求解。",
        "real_problem": "Build fast surrogate solvers for Burgers, Darcy, Navier-Stokes, and related parametric PDE workloads.",
        "real_problem_zh": "为 Burgers、Darcy、Navier-Stokes 等参数化 PDE 工作负载构建快速代理求解器。",
        "project_hooks": ["algorithm:fno_lite_operator", "benchmark:reaction_diffusion_operator_faithful_small"],
        "tags": ["paper", "fno", "operator-learning", "pde"],
        "tags_zh": ["论文", "FNO", "算子学习", "偏微分方程"],
    },
)
...
def _llm_wiki_okf_payload() -> dict[str, object]:
    ...
    for paper in CURATED_PAPER_PROBLEM_CASES:
        ...
        nodes.append(
            _okf_node(
                ...
                timestamp,
                title_zh=str(paper["title_zh"]),
                description_zh=_compact_summary(str(paper["summary_zh"]), 520),
                tags_zh=[str(tag) for tag in paper.get("tags_zh", [])],
                real_problem=str(paper["real_problem"]),
                real_problem_zh=str(paper["real_problem_zh"]),
                source={
                    "url": paper["url"],
    ...
    return {
        ...
        "title_zh": "AgenticSciML LLM Wiki 知识图谱",
        "description": "Editable bilingual OKF-like JSON graph for repository, workflow, benchmark, algorithm, and paper-problem context.",
        "description_zh": "面向 LLM 的可编辑双语 OKF-like JSON 知识图谱，覆盖项目、工作流、benchmark、算法种子、真实论文和现实问题。",
        "tags": ["agenticsciml", "llm-wiki", "okf", "knowledge-graph"],
        "tags_zh": ["科学机器学习", "LLM Wiki", "OKF", "知识图谱"],
        "timestamp": timestamp,
        "languages": ["en", "zh-CN"],
        "generator": {
            ...
            "uses_network": False,
            "source_boundary": "Repository catalog plus manually reviewed paper-problem metadata.",
        },
        "edit_policy": {
            "manual_editing": True,
        ...
        "author_scan": {
            ...
            "curated_paper_problem_case_count": len(CURATED_PAPER_PROBLEM_CASES),
            "george_karniadakis_recent_paper_count_included": 5,
        },
        "nodes": nodes,
        "edges": edges,
    }

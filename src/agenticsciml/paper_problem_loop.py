...
SOURCE_MAPPING_THEMES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("safe_control", ("safe-control", "safe control", "stabilization", "adversarial", "disturbance", "game-theoretic")),
    ("reliability", ("reliability", "fidelity", "stability", "diagnostic", "sensitivity", "consistency")),
    ...
    ("fluid", ("fluid", "turbulence", "turbulent", "wake", "vortex")),

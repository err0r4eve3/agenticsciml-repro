...
- [Benchmark 与实验设计](benchmark_plan.md)：6 类 benchmark 的本地代理、验证矩阵和真实 LLM 实验顺序。
...
4. 做实验时读 [Benchmark 与实验设计](benchmark_plan.md)、[Real LLM 运行](real_run.md)、[Ablation 说明](ablation.md) 和 [版本说明](version_notes.md)。

...
- [Stage A Risk Register](risk_register.md)：记录 faithful-small Stage A 证据链的已关闭风险、仍开放 blocker、artifact 路径和对外 claim 边界。

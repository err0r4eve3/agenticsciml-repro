...
sample count, collocation count, network depth, network width, residual weight,
and training schedule. In AgenticSciML, the Python orchestrator keeps control of
state, score, files, and champion selection, while the agent proposes one
bounded mutation with structured output.
